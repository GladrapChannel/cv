...
if (isMobileClient() && !href.match(/\?responsive=off/)) {
  var documentApp = function() {
    ...
    g.type = "text/css";
    g.innerHTML = '@media all and (max-width:1000px){#drWebVersionTop a {font-size:xx-small;color:black;} #drMainSection img{margin-bottom:30px !important;}#drMainSection font a i,#drMainSection font a b,#drMainSection font a font{text-decoration:underline;}#drTopSection a{margin-top:7px;}#drTopSection br+br+br, #drTopSection br+br{display:none;}#app_mainheadline,#app_topstories,body>tt,center a,table{display:none} body{max-width:1000px;overscroll-behavior:none;overflow-x:hidden!important;font-family:monospace;font-size:1.52em;font-weight:700}img{max-width:98%;height:auto;margin-bottom:5px}font{font-size:24pt;font-family:ARIAL,VERDANA,HELVETICA!important;font-style:normal}.drMonospace,.drMonospace font,a,a font{font-family:monospace!important;font-size:1em;font-weight:700;width:100%;display:inline-block}a,a font{text-decoration:underline}.drMainSection *,body>font a{display:inline-block;text-align:center;font-size:34px;font-family:ARIAL,VERDANA,HELVETICA!important}font[face="ARIAL,VERDANA, HELVETICA"] a{font-size:26pt;display:inline-block;font-family:ARIAL,VERDANA,HELVETICA!important;text-align:center;width:100%;}font[face="ARIAL,VERDANA, HELVETICA"] img{max-width:75%;width:100%;margin:auto;height:auto;display:block;}hr{margin:6px 0}#drLogo{margin-top:-35px;margin-bottom:15px;text-align:center;}body>font img{max-width:80%;margin:auto;display:block;}br+br+a{margin-top:-8px}}';
